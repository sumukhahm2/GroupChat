...
const GroupDetails=()=>{
    ...
    const dispatch=useDispatch()
      ...
      //useFetch(`http://51.20.129.197:3000/groupchat/groupdetails?groupid=${params.groupid}`,'GROUP-DETAILS')
  ...
  console.log(currentUser)
    ...
    const changeAuthority=async(datas)=>{
        ...
        const response=await fetch(`http://51.20.129.197:3000/groupchat/updateauthority`,
            {
                method:'POST',
    ...
    const exitGroup=async(groupid,authId)=>{
      ...
      {
       response=await fetch('http://51.20.129.197:3000/groupchat/exitgroup',{
        method:'POST',
